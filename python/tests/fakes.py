...
UNITS: dict[int, tuple] = {
    ...
    U.Terran_Siege_Tank_Siege_Mode: (_T, 150, 100, 750, 4, 0, 150, 0, 1, W.Arclite_Shock_Cannon, NONE_W, 12, 3, U.Terran_Factory, 1, 1, 1, MECH | ATK, [U.Terran_Machine_Shop]),
...
WEAPONS: dict[int, tuple] = {
    ...
    W.Arclite_Shock_Cannon: (70, 5, 75, 1, 1, 64, 384, 40, False, True, UpgradeType.Terran_Vehicle_Weapons),
